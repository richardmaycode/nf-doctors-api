...
Location.create! name: "Hope Clinic", address_line_1: "9200 W Wisconsin Ave", address_line_2: "", city: "Milwaukee", state: "WI", zipcode: "53226", nf_type_ids: [ 1, 2, 3 ], age_group_ids: [ 2 ], facility_id: 73
Location.create! name: "Neurofibromatosis Clinic", address_line_1: "1221 Lee Street", address_line_2: "", city: "Charlottesville", state: "VA", zipcode: "22903", nf_type_ids: [ 1, 2 ], age_group_ids: [ 1 ], facility_id: 92
Location.create! name: "Neurofibromatosis Clinic", address_line_1: "111 Colchester Ave", address_line_2: "", city: "Burlington", state: "VT", zipcode: "05401", nf_type_ids: [ 1, 2, 3 ], age_group_ids: [ 1, 2 ], facility_id: 96
Location.create! name: "Alvord Brain Tumor Center", address_line_1: "4800 Sand Point Way NE", address_line_2: "", city: "Seattle", state: "WA", zipcode: "98105", nf_type_ids: [ 1, 2, 3 ], age_group_ids: [ 2 ], facility_id: 97
Location.create! name: "Dell Children's Neurofibromatosis Clinic", address_line_1: "4910 Mueller Blvd", address_line_2: "Specialty Pavilion, Suite 300-Neurology", city: "Austin", state: "TX", zipcode: "78723", nf_type_ids: [ 1, 2, 3 ], age_group_ids: [ 1 ], facility_id: 63
Location.create! name: "Neurogenetics", address_line_1: "505 Farmington Avenue", address_line_2: "", city: "Farmington", state: "CT", zipcode: "06032", nf_type_ids: [ 1, 2 ], age_group_ids: [ 1 ], facility_id: 16
Location.create! name: "Neurocutaneous Syndromes Clinic", address_line_1: "9300 Valley Childrens Place", address_line_2: "", city: "Madera", state: "CA", zipcode: "93636", nf_type_ids: [ 1, 2, 3 ], age_group_ids: [ 1 ], facility_id: 11
Location.create! name: "LPCH Pediatric Neurosurgery", address_line_1: "730 Welch Road", address_line_2: "2nd Floor", city: "Palo Alto", state: "CA", zipcode: "94304", nf_type_ids: [ 1, 2 ], age_group_ids: [ 1 ], facility_id: 11
Location.create! name: "RASopathy/Neurofibromatosis Genetic Clinic", address_line_1: "730 Welch Road ", address_line_2: "", city: "Palo Alto", state: "CA", zipcode: "94304", nf_type_ids: [ 1, 2, 3 ], age_group_ids: [ 1 ], facility_id: 12
